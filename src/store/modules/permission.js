  ...
  actions: {
    GenerateRoutes ({ commit }, data) {
      return new Promise(resolve => {
        ...
        // if (accessedRouters.length>1 && accessedRouters[0]["children"].length>0){
        //   let firstChidren =  accessedRouters[0]["children"][0]
        //   if (firstChidren["children"].length >0){
        //     accessedRouters[0]["redirect"] = firstChidren["children"]["path"]
        //   }else {
        //     accessedRouters[0]["redirect"] = firstChidren["path"]
        //   }
        // }
